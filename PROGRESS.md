...
次のアクション：
- [ ] 音声 I2S 化（GP26/27、PIO ベース、Core 1 オフロード）
- [ ] メニュー UI
...
| 音声方式 | 現状 PWM（GP26/27、DMA ダブルバッファ）。I2S PIO 化でジッター低減・Core 1 オフロード可能。ハード的には GP26/27 を PIO I2S に割り当て可能なため実装予定 |
