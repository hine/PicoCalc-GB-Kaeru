...
最終更新: 2026-05-25（メニュー UI 実装完了・F5 ソフトリセット追加）

---

## 現在のフォーカス

**Milestone 9: 携帯機化** → ほぼ完了

残タスク：
- [ ] F1 スリープ動作確認・修正（dormant 移行の安定化）
- [ ] GBC 対応（Milestone 8）
...
- [x] F5 ソフトリセット（GB 再初期化 + Flash SRAM リロード、実機確認済み 2026-05-25）
- [ ] F1 スリープ dormant 安定化（現在未動作）
